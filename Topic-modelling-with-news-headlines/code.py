...
for i, topic in enumerate(lsa_model.components_):
    topic_lsa["Topic {}".format(i)] = ' + '.join([(vectorizer.get_feature_names()[i] + '*' + str(topic[i])) for i in topic.argsort()[:-11:-1]])
    


    
# pretty print topics
# pprint(lsa_model.print(topic_lsa))
...
# coherence_model_lda.print_topics(num_topics=5)
